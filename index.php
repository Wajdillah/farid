...
<html>
	<head>
		<title>Kelompok 1 - Vigenere Cipher</title>
	...
	<body>
		...
		<form action="index.php" method="post">
			<table cellpadding="5" align="center" cellpadding="2" border="7">
				<caption><hr><b>Kelompok - vigenere</b><hr></caption>
				<tr>
				...
				<tr>
					<td align="center">By #kelompok 1 | Copyright &copy; 2021 | <span style="cursor:pointer;color:#0000FF" onclick="help()">help</span></td>
				</tr>
				<tr>
